...
public class FingerPrintAuthHelper {
    ...
    //error messages
    private static final String ERROR_FAILED_TO_GENERATE_KEY = "15080811-E0DC-4F3E-B826-C799D3477967";
    private static final String ERROR_FAILED_TO_INIT_CHIPPER = "";
    ...
    /**
     * {@link OnFingerPrintAuthCallback} to notify the parent caller about the authentication status.
     */
    private OnFingerPrintAuthCallback mCallback;
     ...
     * Private constructor.
     */
    private FingerPrintAuthHelper(@NonNull Context context, @NonNull OnFingerPrintAuthCallback callback) {
        mCallback = callback;
        mContext = context;
    }
     ...
     * @param callback {@link OnFingerPrintAuthCallback} to get notify whenever authentication success/fails.
     * @return {@link FingerPrintAuthHelper}
     */
    @SuppressWarnings("ConstantConditions")
    public static FingerPrintAuthHelper getHelper(@NonNull Context context, @NonNull OnFingerPrintAuthCallback callback) {
        if (context == null) {
            throw new IllegalArgumentException("Context cannot be null.");
        } else if (callback == null) {
            throw new IllegalArgumentException("OnFingerPrintAuthCallback cannot be null.");
        }
            ...
            fingerprintManager.authenticate(cryptoObject, mCancellationSignal, 0,
                    new FingerprintManager.AuthenticationCallback() {
                        ...
                        public void onAuthenticationFailed() {
                            mCallback.onFingerPrintAuthFailed(OnFingerPrintAuthCallback.CANNOT_RECOGNIZE_ERROR, null);
                        }
