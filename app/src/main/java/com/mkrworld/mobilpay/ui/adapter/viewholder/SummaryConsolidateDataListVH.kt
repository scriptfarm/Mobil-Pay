...
class SummaryConsolidateDataListVH : BaseViewHolder<DTOSummaryConsolidateDataList> {

    companion object {
        private val TAG = BuildConfig.BASE_TAG + ".SummaryConsolidateDataListVH"
    }
    ...
    private fun getSummaryConsolidateDataList(dtoSummaryConsolidateDataList : DTOSummaryConsolidateDataList) : ArrayList<BaseAdapterItem<*>> {
        ...
        for (dtoSummaryConsolidateData in dtoSummaryConsolidateDataList.dtoSummaryConsolidateDataList) {
