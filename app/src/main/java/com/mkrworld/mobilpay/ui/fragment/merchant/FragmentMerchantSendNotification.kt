...
class FragmentMerchantSendNotification : Fragment(), OnBaseFragmentListener, View.OnClickListener {
    ...
    override fun onCreateView(inflater : LayoutInflater?, container : ViewGroup?, savedInstanceState : Bundle?) : View? {
        return inflater !!.inflate(R.layout.fragment_merchant_send_notification, container, false)
    }
    ...
    override fun onClick(view : View) {
        ...
        when (view.id) {
            R.id.fragment_merchant_send_notification_textView_cancel -> {
                activity?.onBackPressed()
            }
            R.id.fragment_merchant_send_notification_textView_send -> {
                ...
                for (index : Int in 0 .. (mBaseAdapter !!.itemCount - 1)) {
                    ...
                    if (item.getData() is DTOMerchantNotificationData) {
                        var data = item.getData() as DTOMerchantNotificationData
                        if (data.isChecked) {
    ...
    private fun init() {
        ...
        view !!.findViewById<View>(R.id.fragment_merchant_send_notification_textView_cancel).setOnClickListener(this)
        view !!.findViewById<View>(R.id.fragment_merchant_send_notification_textView_send).setOnClickListener(this)
        val recyclerViewUserData = view !!.findViewById<View>(R.id.fragment_merchant_send_notification_recycler_view) as RecyclerView
        ...
        baseAdapterItemArrayList.add(BaseAdapterItem(AdapterItemHandler.AdapterItemViewType.MERCHANT_NOTIFICATION_DATA_ITEM.ordinal, DTOMerchantNotificationData(1, "PAID")))
        baseAdapterItemArrayList.add(BaseAdapterItem(AdapterItemHandler.AdapterItemViewType.MERCHANT_NOTIFICATION_DATA_ITEM.ordinal, DTOMerchantNotificationData(0, "UNPAID")))
        baseAdapterItemArrayList.add(BaseAdapterItem(AdapterItemHandler.AdapterItemViewType.MERCHANT_NOTIFICATION_DATA_ITEM.ordinal, DTOMerchantNotificationData(3, "PARTIAL-PAID")))
    ...
    private fun sendNotification(list : ArrayList<String>) {
        ...
        mMerchantNetworkTaskProvider !!.sendNotificationTaskTask(activity, dtoSendNotificationRequest, mNotificationResponseNetworkCallBack)
    }
}
