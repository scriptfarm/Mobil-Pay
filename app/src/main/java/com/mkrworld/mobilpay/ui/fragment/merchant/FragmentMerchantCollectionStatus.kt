...
class FragmentMerchantCollectionStatus : Fragment(), OnBaseFragmentListener, View.OnClickListener {

    companion object {
        private val TAG = BuildConfig.BASE_TAG + ".FragmentMerchantCollectionStatus"
    }
    ...
    override fun onCreateView(inflater : LayoutInflater?, container : ViewGroup?, savedInstanceState : Bundle?) : View? {
        return inflater !!.inflate(R.layout.fragment_merchant_collection_status, container, false)
    }
    ...
    private fun init() {
        ...
        val recyclerViewUserData = view !!.findViewById<View>(R.id.fragment_merchant_collection_status_recycler_view) as RecyclerView
