 ...
 */
public class MerchantLogoutTask extends MobilPayBaseTask<DTOMerchantLogoutResponse> {
    private static final String TAG = BuildConfig.BASE_TAG + ".MerchantLogoutTask";
     ...
     */
    public MerchantLogoutTask(Context context, JSONObject requestJson, NetworkCallBack networkCallBack) {
        super(context, requestJson, networkCallBack);
    }

    @Override
    public DTOMerchantLogoutResponse parseNetworkResponse(JSONObject jsonObject) {
        return new Gson().fromJson(jsonObject.toString(), DTOMerchantLogoutResponse.class);
    }
