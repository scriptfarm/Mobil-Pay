 ...
 */
class DTOCollectionSummaryConsolidateData {

    companion object {
        private val TAG = BuildConfig.BASE_TAG + ".DTOCollectionSummaryConsolidateData"
    }
    ...
    override fun equals(obj : Any?) : Boolean {
        if (obj is DTOCollectionSummaryConsolidateData) {
            val dtoMerchantHomeTab = obj as DTOCollectionSummaryConsolidateData?
