package com.mkrworld.mobilpay.dto.comms.collectionsummary
...
class DTOCollectionSummaryResponse {

    companion object {
        private val TAG = BuildConfig.BASE_TAG + ".DTOCollectionSummaryResponse"
    }
