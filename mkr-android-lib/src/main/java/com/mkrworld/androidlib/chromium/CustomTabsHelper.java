...
public class CustomTabsHelper {
    private static final String TAG = BuildConfig.BASE_TAG + ".CustomTabsHelper";
     ...
     */
    public static void openCustomTab(final Activity context, final CustomTabsIntent customTabsIntent, final Uri uri, final CustomTabFallback fallback) {
